...
# === CONFIG ===
API_KEY = os.getenv("CLAUDE_API_KEY")  # Updated to match your .env file
...
def load_data():
    ...
    try:
        ...
        print(f"   ✅ Loaded {len(metadata)} keywords from {INPUT_FILE}")
...
def generate_pages():
    ...
    print(f"   ⚠️ Failed (used fallback): {failed}")
