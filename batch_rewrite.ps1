...
$batchSize   = 20
$contentDir  = ".\content\activities"  # Based on your current structure
$songsJson   = ".\assets\seeds_songs.json"
$styleGuide  = ".\seeds_style_guide.txt"
$statePath   = ".\tmp\rewrite_state.json"
$minScore    = 0.18
$topK        = 5
...
Write-Host "=== All pages processed successfully! ===" -ForegroundColor Magenta